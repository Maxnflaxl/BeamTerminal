...
export const api = {
  ...
  charts: {
    hashrate:   (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/hashrate${qs(o)}`),
    coinbase:   (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/coinbase${qs(o)}`),
    assets:     (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/assets${qs(o)}`),
    dexVolume:  (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/dex-volume${qs(o)}`),
    difficulty: (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/difficulty${qs(o)}`),
    price:      (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/price${qs(o)}`),
    blockTime:  (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/block-time${qs(o)}`),
    tvl:        (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/tvl${qs(o)}`),
    ...
    transactionsDaily:   (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/transactions-daily${qs(o)}`),
    transactionsTotal:   (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/transactions-total${qs(o)}`),
    txosTotal:           (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/txos-total${qs(o)}`),
    utxosTotal:          (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/utxos-total${qs(o)}`),
    sizeTotal:           (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/size-total${qs(o)}`),
    archiveTotal:        (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/archive-total${qs(o)}`),
    shieldedInsDaily:    (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/shielded-ins-daily${qs(o)}`),
    shieldedInsTotal:    (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/shielded-ins-total${qs(o)}`),
    shieldedOutsDaily:   (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/shielded-outs-daily${qs(o)}`),
    shieldedOutsTotal:   (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/shielded-outs-total${qs(o)}`),
    contractsTotal:      (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/contracts-total${qs(o)}`),
    feesDaily:           (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/fees-daily${qs(o)}`),
    feesTotal:           (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/fees-total${qs(o)}`),
    contractCallsDaily:  (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/contract-calls-daily${qs(o)}`),
    contractCallsTotal:  (o: { res?: ChartRes } = {}) => get<ApiChartSeries>(`/charts/contract-calls-total${qs(o)}`),
