...
export const api = {
  ...
  daoTreasuryAsset: (aid: number, limit = 100): Promise<ApiDaoAssetHistory> => get<ApiDaoAssetHistory>(`/dao/treasury/asset/${aid}?limit=${limit}`),
  daoRevenue: (groupBy: 'source' | 'pool' | 'tier' | 'asset' = 'source'): Promise<ApiDaoRevenue> => get<ApiDaoRevenue>(`/dao/revenue?groupBy=${groupBy}`),
  daoGovernance: (): Promise<ApiDaoGovernance> => get<ApiDaoGovernance>('/dao/governance'),
  daoProposal: (id: number, offset = 0, limit = 25): Promise<ApiDaoProposalDetail> => get<ApiDaoProposalDetail>(`/dao/governance/proposals/${id}?offset=${offset}&limit=${limit}`),
  ...
  charts: {
    hashrate:   (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/hashrate${qs(o)}`),
    coinbase:   (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/coinbase${qs(o)}`),
    assets:     (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/assets${qs(o)}`),
    dexVolume:  (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/dex-volume${qs(o)}`),
    difficulty: (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/difficulty${qs(o)}`),
    ...
    transactionsTotal:   (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/transactions-total${qs(o)}`),
    txosTotal:           (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/txos-total${qs(o)}`),
    utxosTotal:          (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/utxos-total${qs(o)}`),
    sizeTotal:           (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/size-total${qs(o)}`),
    archiveTotal:        (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/archive-total${qs(o)}`),
    shieldedInsDaily:    (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/shielded-ins-daily${qs(o)}`),
    shieldedInsTotal:    (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/shielded-ins-total${qs(o)}`),
    shieldedOutsDaily:   (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/shielded-outs-daily${qs(o)}`),
    shieldedOutsTotal:   (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/shielded-outs-total${qs(o)}`),
    contractsTotal:      (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/contracts-total${qs(o)}`),
    feesDaily:           (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/fees-daily${qs(o)}`),
    feesTotal:           (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/fees-total${qs(o)}`),
    contractCallsDaily:  (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/contract-calls-daily${qs(o)}`),
    contractCallsTotal:  (o: { res?: ChartRes; from?: number; to?: number } = {}) => get<ApiChartSeries>(`/charts/contract-calls-total${qs(o)}`),
