...
const reducer = createReducer<DexStateType, Action>(initialState)
  ...
  .handleAction(actions.setPoolsList, (state, action) =>
    produce(state, (nexState) => {
      nexState.poolsList = action.payload;
      nexState.isLoading = false;
    }),
  )
  .handleAction(actions.setTxStatus, (state, action) =>
    produce(state, (nexState) => {
      nexState.tx_status = action.payload;
    }),
  )
  .handleAction(actions.setTransactionStatus, (state, action) =>
    produce(state, (nexState) => {
      nexState.statusTransaction = action.payload;
    }),
  )
  .handleAction(actions.setPredict, (state, action) =>
    produce(state, (nexState) => {
      nexState.predict = action.payload;
    }),
  )
  .handleAction(actions.setCurrentPool, (state, action) =>
    produce(state, (nexState) => {
  ...
  .handleAction(actions.setFeeFilter, (state, action) =>
    produce(state, (nexState) => {
      nexState.feeFilter = action.payload;
    }),
  )
  .handleAction(actions.setOptions, (state, action) =>
    produce(state, (nexState) => {
      nexState.options = action.payload;
    }),
  )
  .handleAction(actions.setFavorites, (state, action) =>
    produce(state, (nexState) => {
      nexState.favorites = action.payload;
    }),
  )
  .handleAction(actions.setFavoriteAssets, (state, action) =>
    produce(state, (nexState) => {
      nexState.favoriteAssets = action.payload;
    }),
  )
  .handleAction(actions.setCurrentLPToken, (state, action) =>
    produce(state, (nexState) => {
      nexState.currentPool = action.payload;
    }),
  )
  .handleAction(actions.setIsLoading, (state, action) =>
    produce(state, (nexState) => {
      nexState.isLoading = action.payload;
    }),
  )
  .handleAction(actions.setIsHeadless, (state, action) =>
    produce(state, (nexState) => {
  ...
  .handleAction(actions.setRewardsState, (state, action) =>
    produce(state, (nexState) => {
